...
<<?php print $layout_wrapper; print $layout_attributes; ?> class="<?php print $classes;?> l-node-used-vehicle--featured-vehicles">

	<?php if(!empty($photo)): ?>
		<div class="l-node-used-vehicle--featured-vehicles__photo">
			<?php print $photo; ?>
		</div>
	<?php endif; ?>

	<?php if(!empty($make_model)): ?>
		<div class="l-node-used-vehicle--featured-vehicles__make-model">
			<?php print $make_model; ?>
		</div>
	<?php endif; ?>

	<?php if(!empty($price) || !empty($was_price) || !empty($saving_price)): ?>
		<div class="l-node-used-vehicle--featured-vehicles__price">
			<?php print $price; ?>
			<?php if(!empty($was_price) || !empty($saving_price)): ?>
				<div class="l-node-used-vehicle--featured-vehicles__saving-price">
					<?php print $was_price; ?>
