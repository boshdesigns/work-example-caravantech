...
<<?php print $layout_wrapper; print $layout_attributes; ?> class="<?php print $classes;?> l-node-used-vehicle--similar-vehicles">
	...
	<?php if(!empty($price) || !empty($was_price) || !empty($saving_price)): ?>
		<div class="l-node-used-vehicle--similar-vehicles__price">
			...
			<?php if(!empty($was_price) || !empty($saving_price)): ?>
				<div class="l-node-used-vehicle--similar-vehicles__saving-price">
					<?php print $was_price; ?>
